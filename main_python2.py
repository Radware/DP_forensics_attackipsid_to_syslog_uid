...
print('DP Forensics attackipsid to syslogid v1.0 - by Egor Egorov')
print('Modified for Python from 2.6 to 3.6 and formatted as CSV - by Michael Weinstein')
print('----------------------------------------------------------')
...
for id in attackipsid:
    ...
    if id:
        ...
        ###################### First part and Syslog construction ######################
            ...
            print("AttackIpsID, {}".format(id) + ", syslog ID, {}".format(syslog_id))
